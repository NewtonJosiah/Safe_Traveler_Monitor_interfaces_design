...
### Traveler Interface
- **Start Journey**: Begin tracking with selction of a destination on map and autogenerated estimated arrival time
...
1. **Traveler starts journey**: The user selects their destination on the map, presses the start button and autommacally generates estimated travel time
