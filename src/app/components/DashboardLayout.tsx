...
import { TravelerInterface } from './TravelerInterface';
    ...
    <div className="size-full">
      ...
      <div className="fixed top-4 right-4 z-50 bg-white rounded-full shadow-lg p-2 flex gap-2">
        ...
        <button
          ...
          className="px-4 py-2 rounded-full flex items-center gap-2 bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors"
          title="Logout"
        >
